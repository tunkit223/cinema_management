...
public class ShiftTypeController {
    ...
    public ApiResponse<ShiftTypeResponse> createShiftTemplate(
            ...
            @Valid @RequestBody CreateShiftTypeRequest request) {
    ...
    @GetMapping
    public ApiResponse<List<ShiftTypeResponse>> getShiftTemplates(
            @PathVariable String cinemaId) {
    ...
    public ApiResponse<String> deleteShiftTemplate(
            @PathVariable String cinemaId,
            @PathVariable String shiftId) {

        shiftTypeService.delete(cinemaId, shiftId);
        return ApiResponse.<String>builder()
                .result(STR."Delete shift type id: \{shiftId} successfully")
                .build();
    }
}
