...
public class RevenueReprocessService {
    ...
    public void reprocessAllPayments() {
        ...
        List<Payment> successfulPayments = paymentRepository
                .findByStatusIn(List.of(PaymentStatus.SUCCESS));
        ...
        List<Invoice> refundedInvoices = invoiceRepository
                .findByStatus(InvoiceStatus.REFUNDED);
        ...
        log.info("Revenue reprocessing completed. Payments - Success: {}, Failed: {}. Refunds - Success: {}, Failed: {}", 
                successCount, failCount, refundCount, refundFailCount);
    }
}
